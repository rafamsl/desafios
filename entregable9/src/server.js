...
const __dirname = "/Users/rafaellima/Documents/Backend/Coder House/desafios/entregable9/"
const app = express();
...
io.on('connection', clienteNuevo => {
	...
	clienteNuevo.on('new msg', newMsg => {
		ALL_HANDLERS.newMessage(clienteNuevo,io,newMsg)
	})
	// clienteNuevo.on('change alias',alias => {
	// 	ALL_HANDLERS.userChangeAlias(clienteNuevo,io,alias)
	// })
});
